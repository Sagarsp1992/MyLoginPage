sap.ui.define([
		...
		"use strict";
		return BaseObject.extend("ssp.Project_GIT.controller.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias ssp.Project_GIT.controller.ListSelector
			 */
			 ...
			 * @return {ssp.Project_GIT.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
