sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("ssp/Project_GIT/app", ".html");
		sHash = sHash || "";
		sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

		if (sHash) {
			sHash = "#ProjectforGitDemo-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
		} else {
			sHash = "#ProjectforGitDemo-display";
		}

		return sUrl + sUrlParameters + sHash;
	}

	return Opa5.extend("ssp.Project_GIT.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["ssp/Project_GIT/localService/mockserver"], function (mockserver) {
